...
var Nd=[B.B,B.I],Od=function(a){var b=a[B.Sd];b&&E(40);var c=a[B.Td];c&&E(41);for(var d=Ea(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==B.Sd&&f!==B.Td)if(-1<Fa(Nd,f)){var h=f,k=a[f],l=d[e];yd().set(h,k,l,"RU","RU-MOW",c)}else{}},Pd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
T.length;xa++)la.push(P[T[xa]]);d.apply(this,la)}}function l(S,K){void 0!==c[K]&&d("_set",S,c[K])}function n(S,K){return void 0===K?K:S(K)}function q(S,K){void 0!==K&&(v+="&"+S+"="+K)}var p=Ea,r=W("_gaq",[],!1),u=!1,t="";void 0==c.vtp_trackerName?t="gtm"+Ze()+".":""!==c.vtp_trackerName&&(t=c.vtp_trackerName+".");e("_setAccount","vtp_webPropertyId");d("_set","gtmid",Sj(!0));
e("_setAllowLinker","vtp_allowLinker");
e("_setAllowAnchor","vtp_allowAnchor");e("_setAllowHash","vtp_allowHash");
h("_addIgnoredRef",c.vtp_ignoredRef);h("_addIgnoredOrganic",c.vtp_ignoredOrganic);var v="";if(""!==v){var x=function(S,K,T){for(var U=K.length-1;0<=U;U--){var la=K[U].split("=");if(la[0]===S)return la[1]||"1"}for(var P=T.length-1;0<=P;P--){var xa=T[P].split("=");if(xa[0]===S)return xa[1]||"1"}},z=pe(sn()),w=ne(z,"query").split("&"),y=c.vtp_allowAnchor?ne(z,"fragment").split("&"):[];q("gclid",x("gclid",y,w));q("gclsrc",x("gclsrc",y,w));q("dclid",x("dclid",y,w));d("_set","campaignParams",
...
d("_set","hitCallback",function(){Ba(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){}else if("TRACK_TRANSACTION"==c.vtp_trackType){}else if("LINK"==c.vtp_trackType){}else if("LINK_BY_POST"==c.vtp_trackType){}else if("TRACK_SOCIAL"==c.vtp_trackType){}else if("TRACK_TIMING"==c.vtp_trackType){}else if("DECORATE_LINK"==c.vtp_trackType){}else if("DECORATE_FORM"==c.vtp_trackType){}else d("_trackPageview");
h("_cookiePathCopy",c.vtp_cookiePathCopy);var R=function(){W("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,O(Dh("https","http","://stats.g.doubleclick.net/dc.js",u),R,c.vtp_gtmOnFailure));else if(!a){var ha=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;O(Dh("https://ssl","http://www",ha,u),R,c.vtp_gtmOnFailure)}})}();
